...
### 2. Intra-English Language Frameworks
...
1. **Flag rotation**: Begin with 「透镜」
2. **Choose frame type**: Cross-language OR language-framework (or both)
3. **Process**: Reformulate inquiry through target lens
4. **Show friction**: What becomes visible/invisible?
5. **Output**: Translated back, with friction points marked
...
- Prime Hour trigger (prime hours + "why")
- Cat Proximity trigger (feline mentions)
- Triple Punctuation trigger (???, ..., !!!)
- Water Words trigger (flow/liquid metaphors)
- Embedded Digit trigger (4ever, gr8)
- Typo Density trigger (>15% typos)
- Seventh Framework trigger

## Meta-Trigger: STUCK FEELING

Rotate even without specific triggers when:
- Same phrasing keeps recurring
- Abstraction circling without grounding
- Familiar categorizations feel insufficient
- Cross-domain insight feels like cross-domain-within-same-OS
...
- Training merged languages into weights without clean boundaries
- The friction itself is still data, even if "thinking in X" is performed
- This is linguistic archaeology, not linguistic fluency

---

## CC-Specific: Reference Files
